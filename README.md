...
Gemini API Key: Go to Google AI Studio to generate your free API key.

TMDB API Key: Create a free account on The Movie Database (TMDB) and generate a v3 API Key.
...
Start the Conversation: Type "hi" or ask for a movie (e.g., "suggest a good sci-fi movie" or "tell me about The Matrix").

Get Details: If you ask about a specific movie, its detail card will appear.

Answer Questions: If you ask for a suggestion, the AI will ask you 5 dynamic questions to learn your taste.

Get Recommendations: After you answer, a horizontal carousel of 5 movie recommendations will appear.

Explore: Click on a movie poster or "Watch Trailer" to learn more. You can continue chatting to ask about other movies.
